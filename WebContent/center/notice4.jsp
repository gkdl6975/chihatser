...
<!-- 본문들어가는 곳 -->
<!-- 메인이미지 -->
<div id="sub_img_center4" style="max-height:100%" style="min-height:100%"></div>
<!-- 메인이미지 -->
...
<tr><th class="tno">No.</th>
    ...
    for(int i=0;i<boardList.size();i++){
    	...
    	%>
<tr onclick="location.href='content4.jsp?num=<%=bb.getNum()%>'">
  	<td><%=bb.getNum() %></td>
    <td><img src="../upload/<%=bb.getFile() %>" width="50" height="50"></td>
...
<div id="table_search">
<form action="noticeSearch4.jsp" method="post">
...
if(id!=null){
    ...
    onclick="location.href='writeForm4.jsp'"><%
}
%>
</div>
...
if(startPage > pageBlock){
	%><a href="notice4.jsp?pageNum=<%=startPage-pageBlock%>">Prev</a><%
}	
for(int i=startPage;i<=endPage;i++){
	%><a href="notice4.jsp?pageNum=<%=i %>"><%=i %></a> <%
}
//다음
if(endPage < pageCount){
	%><a href="notice4.jsp?pageNum=<%=startPage+pageBlock%>">Next</a><%
}
%>
</div>
</article>
