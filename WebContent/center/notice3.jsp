...
<tr onclick="location.href='content3.jsp?num=<%=bb.getNum()%>'">
  	<td><%=bb.getNum() %></td>
    <td class="left">	
    <%
// 답글 이면 이미지 보이기
...
if(bb.getRe_lev() > 0){
	...
	for(int a = 1 ; a <= bb.getRe_lev() ;a++){
		
	%>
	
	<img src="../images/zxcz.PNG" width="20" height="10">
	<%
}
}
%>
...
<div id="table_search">
<form action="noticeSearch3.jsp" method="post">
...
if(id!=null){
    ...
    onclick="location.href='writeForm3.jsp'"><%
}
%>
</div>
<div class="clear"></div>
...
if(startPage > pageBlock){
	%><a href="notice3.jsp?pageNum=<%=startPage-pageBlock%>">Prev</a><%
}	
for(int i=startPage;i<=endPage;i++){
	%><a href="notice3.jsp?pageNum=<%=i %>"><%=i %></a> <%
}
//다음
if(endPage < pageCount){
	%><a href="notice3.jsp?pageNum=<%=startPage+pageBlock%>">Next</a><%
}
%>
</div>
</article>
